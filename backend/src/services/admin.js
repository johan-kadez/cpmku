...
import { sendProductApprovedEmail } from './mail.js';
...
export async function setStatus(type, id, status) {
  ...
  if (type === 'rooms') throw new HttpError(400, 'Room tidak menggunakan status approve/reject. Gunakan lifecycle transaksi.');
